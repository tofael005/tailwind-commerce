        ...
        <div className="mt-6">
            <div className="max-w-[1240px] md:flex gap-6 mx-auto px-3">
                <div className="md:w-[800px] mb-6 relative">
                    <img className="md:w-full rounded-md h-[636px] object-cover" src="/src/assets/product/ideogram (11).jpeg" alt="" />
                ...
                <div className="md:w-[400px]">
                    <div className="hover:shadow hover:shadow-black/30 duration-300 rounded-md mb-4">
                    ...
                    <div className="hover:shadow hover:shadow-black/30 duration-300 rounded-md mb-4">
                        ...
                        <div className="flex justify-between items-center p-2">
                            <p className="font-bold">American Burger</p>
                            <p className="text-white font-extrabold px-3 bg-blue-500 rounded-md">$27</p>
                        </div>
                    </div>
                </div>
            </div>
